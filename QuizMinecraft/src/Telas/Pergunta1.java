...
public class Pergunta1 extends JFrame {
	...
	public Pergunta1() {
		...
		JRadioButton rb4 = new JRadioButton("Notch");
		...
		JLabel lblNewLabel = new JLabel("Quem \u00E9 o criador  do Minecraft?");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblNewLabel.setForeground(new Color(75, 0, 130));
		lblNewLabel.setBounds(80, 231, 305, 33);
		panel.add(lblNewLabel);
		
		JRadioButton rb1 = new JRadioButton("Eduardo");
		...
		JRadioButton rb3 = new JRadioButton("PewDiePie");
		...
		JRadioButton rb2 = new JRadioButton("Joe Quinn");
			...
			public void actionPerformed(ActionEvent e) {
				if(!rb1.isSelected() && !rb2.isSelected() &&
				   !rb3.isSelected() && !rb4.isSelected()) {
					...
					Pergunta2 pergunta = new Pergunta2();

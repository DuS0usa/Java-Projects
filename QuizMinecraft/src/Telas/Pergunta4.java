...
public class Pergunta4 extends JFrame {
	...
	public Pergunta4() {
		...
		JRadioButton rb4 = new JRadioButton("1.16");
		...
		JLabel lblNewLabel = new JLabel("Qual vers\u00E3o que a End City foi adicionada?");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblNewLabel.setForeground(new Color(75, 0, 130));
		lblNewLabel.setBounds(36, 237, 372, 33);
		panel.add(lblNewLabel);
		
		JRadioButton rb1 = new JRadioButton("1.9");
		...
		JRadioButton rb3 = new JRadioButton("1.8");
		...
		JRadioButton rb2 = new JRadioButton("1.11");
			...
			public void actionPerformed(ActionEvent e) {
				if(!rb1.isSelected() && !rb2.isSelected() &&
				   !rb3.isSelected() && !rb4.isSelected()) {
					...
					Pergunta5 pergunta = new Pergunta5();

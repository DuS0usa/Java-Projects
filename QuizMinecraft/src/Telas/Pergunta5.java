...
public class Pergunta5 extends JFrame {
	...
	public Pergunta5() {
		...
		JRadioButton rb4 = new JRadioButton("Grama");
		...
		JLabel lblNewLabel = new JLabel("Qual bloco representa o \u00EDcone do jogo?");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblNewLabel.setForeground(new Color(75, 0, 130));
		lblNewLabel.setBounds(36, 237, 372, 33);
		panel.add(lblNewLabel);
		
		JRadioButton rb1 = new JRadioButton("Cascalho");
		...
		JRadioButton rb3 = new JRadioButton("Terra");
		...
		JRadioButton rb2 = new JRadioButton("Areia");
			...
			public void actionPerformed(ActionEvent e) {
				if(!rb1.isSelected() && !rb2.isSelected() &&
				   !rb3.isSelected() && !rb4.isSelected()) {
					...
					TelaFinal pergunta = new TelaFinal();

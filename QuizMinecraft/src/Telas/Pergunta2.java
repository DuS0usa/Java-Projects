...
public class Pergunta2 extends JFrame {
	...
	public Pergunta2() {
		...
		JRadioButton rb4 = new JRadioButton("2012");
		...
		JLabel lblNewLabel = new JLabel("Quando o Minecraft foi lan\u00E7ado?");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 17));
		lblNewLabel.setForeground(new Color(75, 0, 130));
		lblNewLabel.setBounds(80, 231, 305, 33);
		panel.add(lblNewLabel);
		
		JRadioButton rb1 = new JRadioButton("2021");
		...
		JRadioButton rb3 = new JRadioButton("2015");
		...
		JRadioButton rb2 = new JRadioButton("2011");
			...
			public void actionPerformed(ActionEvent e) {
				if(!rb1.isSelected() && !rb2.isSelected() &&
				   !rb3.isSelected() && !rb4.isSelected()) {
					...
					Pergunta3 pergunta = new Pergunta3();
